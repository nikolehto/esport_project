...
public class Bat {
    ...
    // This will hold the pixels per second speedthat the mBat will move
    ...
    public Bat(int x, int y){
        ...
        mBatSpeed = mScreenX; // This is quite fast cover entire screen in 1 second
    }

    // This is a getter method to make the rectangle that
    // defines our Bat available in GameView class
